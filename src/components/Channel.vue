      ...
      <div class="channel-info" :style="{'border-bottom-color': channel.color }">
          ...
          <h3>
              ...
              <span v-if="editing">
                  ...
                  <b-button @click.prevent="renameChannel()" type="success" size="small" icon="circle-check">Save</b-button>
                  <b-button @click.prevent="editing = null"  size="small" type="text">Cancel</b-button>
              </span>

              <span v-if="!editing">
                  <b-button @click="editing = channel.channel.title" size="mini" icon="edit"></b-button>
                  <b-button @click="deleteChannel(channel.url)" size="mini" type="danger" icon="delete"></b-button>
              </span>
          </h3>
          ...
          <div class="row">
            <div class="col-8">
              <p class="channel-meta">
                  <b-badge class="fav-count" :value="channel.items.length" /> posts found
